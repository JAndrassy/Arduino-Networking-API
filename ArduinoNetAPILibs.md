...
|[C33 core][108] | 2023 | LwIP   | Ethernet (Eth peripheral), WiFi STA and SoftAP (on board ESP32C3 with Espressif Hosted fw) | Arduino
|[ESP8266 core][110] | 2014 | LwIP   | WiFi STA and SoftAP, Ethernet (W5500, ENC28J60), PPP  | community
|[ESP32 core][112] | 2016 | LwIP   | WiFi STA and SoftAP, Ethernet (Eth peripheral, W5500)  | Espressif
...
|[RP2040 Core][118] | 2022 | LwIP | WiFi STA and SoftAP (Pico W), Ethernet (W5500, ENC28J60) | Earle P |
...
|[RP2040 LwipIntfDev][19] | constructor | status | | ✓ | |
...
|[esp32 Ethernet][13] |linkUp | not blocking | ✗ | wrong param. order | | |
|[EthernetENC][15] | ✓ | ✓ | ✓ | | ✓ | ✓ |
|[STM32Ethernet][16]| ✓ | ✓ | ✓ | | ✓ | ✓ |
|[QNEthernet][17]| ✓ | ✓ | ✓ | | ✓ | |
...
|[esp32 WiFi][212] | ✓ |not blocking | | wrong param. order (PR->)| [PR](https://github.com/espressif/arduino-esp32/pull/8892)| not blocking [PR](https://github.com/espressif/arduino-esp32/pull/9062) |
|[WiFiEspAT][14] | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ |
|[RP2040 WiFi][18] | ✓ | ✓ | | ✓ | + | ✓ |
...
|[WiFiS3][5] | ✓ (1) | ✓ | ✓* | ✓ <del>R [PR](https://github.com/arduino/ArduinoCore-renesas/pull/183)</del>
|[Mbed WiFi][6] |✗| ✓ | + | ✓ R |
...
(1) hostname is not sent with DHCP request
...
|[WiFiNINA][3] | ✓ | ✓R | ✓ | ✓ | ✓ |
|[WiFiS3][5] | ✓ | ✓ | ✓ | ✓ | ✓ |
|[Mbed WiFi][6] | ✓ | [+](https://github.com/arduino/ArduinoCore-mbed/pull/815) | + | ✓ | ✓ |
|[C33 Wifi][8] | ✓ | ✓ | ✓ | ✓ | ✓ |
|[esp8266 WiFi][410] | ✓ | + | ✓ | ✓ | ✓ |
|[esp32 WiFi][412] | ✓ | + | ✓ | ✓(1) | ✓ |
|[WiFiEspAT][14] | ✓ | ✓R | ✓ | ✓ | ✓ |
...
* <del>Arduino Mbed core SocketWrapper ([PR](https://github.com/arduino/ArduinoCore-mbed/pull/770))</del>
* ESP8266WiFi ([issue](https://github.com/esp8266/Arduino/issues/6701))
* ESP32 WiFi

### Method flush()

ESP32 WiFi library still implements `flush` as discard input. [PR](https://github.com/espressif/arduino-esp32/pull/8871)

### copyable

In Mbed Core only one initial copy like returned from `server.available()` may work. ([PR](https://github.com/arduino/ArduinoCore-mbed/pull/768))
...
(2) WiFiClient is used for Ethernet interface too. EthernetCompat for esp8266 has EthernetClient as alias to WiFiClient.
...
|esp32 WiFi | [WiFiClientSecure][92] | ✓| ✓
...
| library | class |  ctor without params | print to all clients |
|---|--- |:---:|:---:|
...
|Mbed SocketWrapper | [MbedServer][46] | PR | ✗ (1) |
...
|WiFiS3 |[WiFiServer][45] | ✓*| ✓* | + | | ✓ | [PR](https://github.com/arduino/ArduinoCore-renesas/pull/144)|
|Mbed SocketWrapper | [MbedServer][46] | PR-> | [PR](https://github.com/arduino/ArduinoCore-mbed/pull/793) | <-PR | returns 0 [issue](https://github.com/arduino/ArduinoCore-mbed/issues/730) | ✗(1) | <-PR
|C33 lwIpWrapper |[lwipServer][48] | ✓ | | | | ✓ | |
...
[92]: https://github.com/espressif/arduino-esp32/blob/master/libraries/WiFiClientSecure/src/WiFiClientSecure.h
